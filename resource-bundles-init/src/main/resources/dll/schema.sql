...
create table basenames (id int4 not null, version int4, name varchar(512) unique, primary key (id));
...
create table properties_keys (id int4 not null, version int4, name varchar(1024) unique, primary key (id));
