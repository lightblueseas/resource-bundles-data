...
create table bundle_application_bundlenames (application_id int4 not null, bundlenames_id int4 not null unique, primary key (application_id, bundlenames_id), unique (bundlenames_id));
...
create table bundlenames (id int4 not null, version int4, filepath varchar(4096), base_name_id int4, locale_id int4, primary key (id));
